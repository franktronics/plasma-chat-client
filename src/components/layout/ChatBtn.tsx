...
const BaseChatBtn = styled.button`
    ...
    .svg-chat-icon{
        transition: .1s transform cubic-bezier(0.02, 0.59, 0.74, 0.66);
    }
    &:hover .svg-chat-icon{
        transform: scale(1.1);
    }
    ...
    &:hover div>span:nth-child(1){
        opacity: 1;
        animation: ${load} cubic-bezier(0.02, 0.59, 0.74, 0.66) .4s .0s
    }
    &:hover div>span:nth-child(2){
        opacity: 1;
        animation: ${load} cubic-bezier(0.02, 0.59, 0.74, 0.66) .4s .1s
    }
    &:hover div>span:nth-child(3){
        opacity: 1;
        animation: ${load} cubic-bezier(0.02, 0.59, 0.74, 0.66) .4s .2s
    }
`
